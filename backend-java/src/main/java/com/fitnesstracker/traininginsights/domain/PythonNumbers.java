...
/**
 * Number handling that matches CPython's, because the analytics output is a contract.
 *
 * <h2>Rounding</h2>
 *
 ...
 * on every tie.
 *
 * <p>Verified against the Python implementation by
 * {@code contract/training-insights-fixtures.json}.
 */
public final class PythonNumbers {
