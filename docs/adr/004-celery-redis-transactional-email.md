...
**Superseded.** Background email now runs on Redis Streams inside the Spring Boot process —
at-least-once with `XAUTOCLAIM` recovery, exponential backoff and a dead-letter stream.
